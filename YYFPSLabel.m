...
//  Copyright © 2017年 zhuhongji. All rights reserved.
//
...
- (void)tick:(CADisplayLink *)link {
    ...
    [text addAttribute:NSForegroundColorAttributeName value:[UIColor whiteColor] range:NSMakeRange(0, text.length - 3)];
